...
const Model = require('../models/kalyanStarLine.Model')
...
module.exports = {
    ...
    create: async (req, res, next) => {
        try {
            ...
            let amountUpdate = {}
            if (data.bidAmount) {
                amountUpdate = await UserModel.updateOne({ _id: mongoose.Types.ObjectId(data.userId) }, { $inc: { wallet: "-" + data.bidAmount } })
            }
